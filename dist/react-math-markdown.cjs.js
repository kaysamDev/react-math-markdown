...
const defaultComponents = {
  table: ({ children, ...props }) => /* @__PURE__ */ jsxRuntime.jsx("div", { style: { overflowX: "auto", margin: "1rem 0" }, children: /* @__PURE__ */ jsxRuntime.jsx(
    "table",
    {
      style: {
  ...
  thead: ({ children, ...props }) => /* @__PURE__ */ jsxRuntime.jsx("thead", { style: { borderBottom: "2px solid #d1d5db" }, ...props, children }),
  ...
  code: ({ children, className, ...props }) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx("code", { className, ...props, children });
  },
  ...
  ul: ({ children, ...props }) => /* @__PURE__ */ jsxRuntime.jsx("ul", { style: { paddingLeft: "1.5rem", margin: "0.5rem 0", listStyleType: "disc" }, ...props, children }),
  ol: ({ children, ...props }) => /* @__PURE__ */ jsxRuntime.jsx("ol", { style: { paddingLeft: "1.5rem", margin: "0.5rem 0", listStyleType: "decimal" }, ...props, children }),
...
function markdownToDraftState(markdown) {
  ...
  try {
    ...
    if (parsed && parsed.blocks && Array.isArray(parsed.blocks)) {
      const contentState2 = draftJs.ContentState.createFromBlockArray(
        parsed.blocks.map(
          (block) => new draftJs.ContentBlock({
            key: block.key || draftJs.genKey(),
      ...
      return draftJs.EditorState.createWithContent(contentState2);
    }
  } catch {
  }
  ...
  for (let i = 0; i < lines.length; i++) {
      ...
      if (inCodeBlock) {
        ...
        blockArray.push(
          new draftJs.ContentBlock({
            ...
            type: "code-block",
            text: codeText2,
            characterList: List(Repeat(draftJs.CharacterMetadata.create(), codeText2.length)),
            depth: 0
          })
        );
        codeBlockLines = [];
    ...
    for (let charIdx = 0; charIdx < plainText.length; charIdx++) {
      ...
      let metadata = draftJs.CharacterMetadata.create();
      for (const style2 of uniqueStyles) {
        metadata = draftJs.CharacterMetadata.applyStyle(metadata, style2);
      }
  ...
  const contentState = draftJs.ContentState.createFromBlockArray(blockArray);
...
exports.MathMarkdown = MathMarkdown;
exports.draftStateToMarkdown = draftStateToMarkdown;
exports.markdownToDraftState = markdownToDraftState;
exports.preprocessDelimiters = preprocessDelimiters;
//# sourceMappingURL=react-math-markdown.cjs.js.map
